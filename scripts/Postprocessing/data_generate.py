...
dmIngraham = IngrahamDataModule(root)
...
testerIngraham.run(mIalpha000, dmIngraham.train_dataloader(), dmIngraham.transfer_batch_to_device)
del mIalpha000
...
testerIngraham.run(mIalpha125, dmIngraham.train_dataloader(), dmIngraham.transfer_batch_to_device)
del mIalpha125
...
dmStrokach = StrokachDataModule(root)
...
testerStrokach.run(mSalpha000, dmStrokach.train_dataloader(), dmStrokach.transfer_batch_to_device)
del mSalpha000
...
testerStrokach.run(mSalpha125, dmStrokach.train_dataloader(), dmStrokach.transfer_batch_to_device)
del mSalpha125
...
testerJLo.run(mJalpha000, dmJLo.train_dataloader(), dmJLo.transfer_batch_to_device)
del mJalpha000
...
testerJLo.run(mJalpha125, dmJLo.train_dataloader(), dmJLo.transfer_batch_to_device)
del mJalpha125
