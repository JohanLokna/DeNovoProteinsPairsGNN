...
from ProteinPairsGenerator.IngrahamModel import IngrahamDataModule, IngrahamModelBERT
...
model = IngrahamModelBERT(20, 128, 128, 128, 3, 3, 21, 30, "full", 0, 0.1, True, False).to(device)
