...
from ProteinPairsGenerator.Testing import TestProteinDesignBasicEmbedding, TestProteinDesignBERTEmbedding
...
testerBasic = TestProteinDesignBasicEmbedding([{"maskFrac": 0.25}, {"maskFrac": 0.50}, {"maskFrac": 0.75}], 40, device)
...
testerBasic.run(mIalpha000, dmIngraham)
del mIalpha000
...
testerBasic.run(mIalpha125, dmIngraham)
del mIalpha125
...
testerBasic.run(mSalpha000, dmStrokach)
del mSalpha000
...
testerBasic.run(mSalpha125, dmStrokach)
del mSalpha125

del dmStrokach
del testerBasic

testerBERT = TestProteinDesignBERTEmbedding([{"maskFrac": 0.25}, {"maskFrac": 0.50}, {"maskFrac": 0.75}], 40, device)
...
testerBERT.run(mJalpha000, dmJLo)
del mJalpha000
...
testerBERT.run(mJalpha125, dmJLo)
del mJalpha125
